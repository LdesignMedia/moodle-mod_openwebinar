...
class PathFilterIteratorTest extends IteratorTestCase {
    ...
    public function getTestFilterData() {
        ...
        $inner[] = new MockSplFileInfo(array(
                'name' => 'abc.dat.copy',
                'relativePathname' => 'copy' . DIRECTORY_SEPARATOR . 'A' . DIRECTORY_SEPARATOR . 'B' . DIRECTORY_SEPARATOR . 'C' .
                        DIRECTORY_SEPARATOR . 'abc.dat',
        ));

        //PATH:   copy/A/B/ab.dat.copy
        $inner[] = new MockSplFileInfo(array(
                'name' => 'ab.dat.copy',
                'relativePathname' => 'copy' . DIRECTORY_SEPARATOR . 'A' . DIRECTORY_SEPARATOR . 'B' . DIRECTORY_SEPARATOR .
                        'ab.dat',
        ));
        ...
        return array(
                ...
                array($inner, array('A'), array(),
                      array('abc.dat', 'ab.dat', 'a.dat', 'abc.dat.copy', 'ab.dat.copy', 'a.dat.copy')),
